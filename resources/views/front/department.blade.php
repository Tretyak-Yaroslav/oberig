...
<div class="main-container">
    <div class="content-container">
        ...
        <div class="department">
            <div class="vector">
                <img class="lazy" data-lazy="/img/icons/Vector.svg" alt="vector" />
                <img class="lazy" data-lazy="/img/icons/Vector.svg" alt="vector" />
                <h3>Відділення і центри</h3>
            </div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="department_link">
                        <a href="#">Діагностичне відділення</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Інсультний центр</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Клініко-діагностична лабораторія</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Клініко-консультативне відділення</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Невідкладна допомога</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Патогістологічний центр</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Поліфункціональний стаціонар </a>
                    </div>
                    <div class="department_link">
                        <a href="#">Центр ендоскопії та малоінвазивної хірургії</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Центр здоров’я жінки
                            (акушерство і гінекологія)</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Центр онкології </a>
                    </div>
                    <div class="department_link">
                        <a href="#">Центр пластичної і реконструктивної хірургії Оберіг “Beauty”</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Центр проктології</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Центр променевої терапії</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Центр психосоматики та депресій
                            Центр реабілітації</a>
                    </div>
                    <div class="department_link">
                        <a href="#">Центр хірургії печінки, підшлункової залози і трансплантації</a>
                    </div>
                </div>
